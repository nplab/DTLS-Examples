...
// it would be better to have this living in a file that can be updated
// but for now let's just bundle it

static char *caBundle;
...
#ifndef NEAT_USETLS
void tls_init_trust_list(void *ctx)
{
}
#endif
